  ...
  return (
    <div className="relative flex-col flex h-screen w-full items-center justify-center overflow-hidden rounded-lg bg-background md:shadow-xl">
      ...
      <div className="overflow-hidden">
        <h1
          ref={(el) => elementsRef.current.push(el)}
          className="z-50 whitespace-pre-wrap uppercase text-center text text-4xl md:text-9xl font-bold tracking-wide text-[#ECFB5C]"
        >
          Front-End
        </h1>
      </div>
      ...
      <div className="overflow-hidden">
        <h1
          ref={(el) => elementsRef.current.push(el)}
          className="z-50 whitespace-pre-wrap uppercase text-center text text-4xl md:text-5xl font-bold tracking-wide text-white"
        >
          Based in Lahore
        </h1>
      </div>

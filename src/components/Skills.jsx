...
const Skills = () => {
  ...
  return (
    <div id='skills' className="bg-black border border-[#ffffff24] mx-5 mb-14 text-white relative flex gap-3 flex-col md:flex-row py-10 p-5 md:p-10 rounded-3xl">
             <Circle/>
             <Circle3/>
      ...
      <div className="flex flex-wrap z-40  w-auto md:w-1/2  gap-5">
        {services.map((service, index) => (
          <div
            key={index}
            className="gap-2 items-center flex w-full justify-between border border-[#fff4] rounded-full p-4 hover:scale-105 transition-all duration-200"
